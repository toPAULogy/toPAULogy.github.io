...
- a left and right unit $e$ of the bifunctor
...
The final notion we require to define our model is that of a (strict) monoidal functor. This is simply a functor between monoidal categories that respects their monoidal structures. For a locally covariant quantum field theory, $\mathfrak{A}:\mathbf{Loc}\rightarrow \mathbf{Obs}$, this is the requirement that
